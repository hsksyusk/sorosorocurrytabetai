package sorosorocurrytabetai::Schema::Result::User;
...
sorosorocurrytabetai::Schema::Result::User
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WOpteItKyI+JpuxPmBiNoQ
